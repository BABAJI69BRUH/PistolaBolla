...
_G.AutoUova = true
_G.selezionaUovo = "Cracked Egg"
_G.AutoRegali = true
_G.AutoCoins = true
_G.AutoDamage = true
_G.AutoSuperLucky = true
_G.AutoUltraLucky = true

function AutoUova()
local Eggs = game:GetService("Players").LocalPlayer.PlayerScripts.Scripts.Game.Eggs
while _G.AutoUova == true do
game:GetService("ReplicatedStorage")["Buy Egg"]:InvokeServer(_G.selezionaUovo,false,false)
...
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(1)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(2)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(3)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(4)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(5)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(6)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(7)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(8)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(9)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(10)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(11)
wait(.01)
game:GetService("ReplicatedStorage")["Redeem Free Gift"]:InvokeServer(12)
wait(.01)
end
end
...
game:GetService("ReplicatedStorage")["Activate Boost"]:FireServer("Triple Coins")
wait(1140)
end
end
...
game:GetService("ReplicatedStorage")["Activate Boost"]:FireServer("Triple Damage")
wait(1740)
end
end

function AutoSuperLucky()
while _G.AutoSuperLucky == true do
game:GetService("ReplicatedStorage")["Activate Boost"]:FireServer("Super Lucky")
wait(1140)
end
end

function AutoUltraLucky()
while _G.AutoUltraLucky == true do
game:GetService("ReplicatedStorage")["Activate Boost"]:FireServer("Ultra Lucky")
wait(840)
end
end
...
Farming:AddLabel("Ricompense:")
Farming:AddToggle({
 Name = "Apri Regali Automaticamente",
 Default = false,
 Callback = function(Value)
    _G.AutoRegali = Value
    AutoRegali()
...
Farming:AddLabel("Boost:")
Farming:AddToggle({
 Name = "Auto Boost Monete Triple",
 Default = false,
 Callback = function(Value)
    _G.AutoCoins = Value
    AutoCoins()
...
Farming:AddToggle({
 Name = "Auto Boost Super Fortunato",
 Default = false,
 Callback = function(Value)
    _G.AutoSuperLucky = Value
    AutoSuperLucky()
    end
})
Farming:AddToggle({
 Name = "Auto Boost Ultra Fortunato",
 Default = false,
 Callback = function(Value)
    _G.AutoUltraLucky = Value
    AutoUltraLucky()
    end
})
local Uova = Window:MakeTab({
 Name = "Uova",
 Icon = "rbxassetid://",
 PremiumOnly = false
})
Uova:AddToggle({
 Name = "Apri Automaticamente",
 Default = false,
 Callback = function(Value)
    _G.AutoUova = Value
    AutoUova()
...
Uova:AddDropdown({
 Name = "Seleziona Uovo",
 Default = "Cracked Egg",
 Options = {"Cracked Egg", "Spotted Egg", "Golden Cracked Egg", "Golden Spotted Egg", "Wood Egg", "Grass Egg", "Golden Wood Egg", "Golden Grass Egg", "Beachball Egg", "Coconut Egg", "Golden Beachball Egg", "Golden Coconut Egg", "Rock Egg", "Geode Egg", "Golden Rock Egg", "Golden Geoge Egg", "Snow Egg", "Ice Egg", "Golden Snow Egg", "Golden Ice Egg", "Icicle Egg", "Yeti Egg", "Golden Icicle Egg", "Golden Yeti Egg", "Cactus Egg", "Spiked Egg", "Golden Cactus Egg", "Golden Spiked Egg", "Obsidian Egg", "Magma Egg", "Golden Obsidian Egg", "Golden Magma Egg", "Enchanted Egg", "Golden Enchanted Egg", "Relic Egg", "Golden Relic Egg", "Samurai Egg", "Golden Samurai Egg", "Rainbow Egg", "Golden Rainbow Egg", "Haunted Egg", "Golden Haunted Egg", "Hell Egg", "Golden Hell Egg", "Heaven Egg", "Golden Heaven Egg", "Empyrean Egg", "Golden Empyrean Egg", "Dark Tech Egg", "Golden Dark Tech Egg", "Titanium Egg", "Golden Titanium Egg", "Tech Egg", "Golden Tech Egg", "Metal Egg", "Golden Metal Egg", "Chemical Egg", "Golden Chemical Egg", "Lab Egg", "Golden Lab Egg", "Mechanical Egg", "Golden Mechanical Egg", "Steampunk Egg", "Golden Steampunk Egg", "Glicth Egg", "Golden Glitch Egg", "Planet Egg", "Golden Planet Egg", "Martian Egg", "Golden Martian Egg", "Alien Egg", "Golden Alien Egg", "Shiny Axolotl Egg", "Axolotl Egg", "Golden Axolotl Egg", "Rainbow Pixel Egg", "Golden Rainbow Pixel Egg", "Cat Egg", "Golden Cat Egg", "Yarn Egg","Golden Yarn Egg", "Paw Egg", "Golden Paw Egg"},
 Callback = function(Value)
    _G.selezionaUovo = Value
    print(_G.selezionaUovo)
    end
})
local RitornaB = Window:MakeTab({
 Name = "Torna All'HUB",
 Icon = "rbxassetid://12378312397",
 PremiumOnly = false
})
...
CoseTest:AddLabel("! ATTENZIONE !")
CoseTest:AddLabel("Prima di eseguire il Chat Bypass")
CoseTest:AddLabel("Usandolo potresti rischiare il ban di roblox.")
CoseTest:AddLabel("Non sono responsabile per nessun ban.")
CoseTest:AddLabel("Usalo a tuo rischio.")
CoseTest:AddButton({
 Name = "Bypassa Chat",
 Callback = function()
    KeyBind = 'F'
...
KeyTuto:AddLabel("! COME OTTENERLA !")
KeyTuto:AddLabel("Clicca su 'Ottieni Key'")
KeyTuto:AddLabel("Incolla il link nel browser")
KeyTuto:AddLabel("Incolla la Key e divertiti!")
